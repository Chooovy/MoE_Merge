...
from component.merge_mixtral_keepWmean_share_U import *
...
# save_model(model, "/aifs4su/lilujun/SVD-MoE-merge/MoE/Mixtral-8x7B_delta-0.5-share-U_keepWmean_share-1_svd_no_scale.pt")
